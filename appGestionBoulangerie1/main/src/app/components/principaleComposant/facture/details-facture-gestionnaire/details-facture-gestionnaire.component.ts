...
@Component({
  selector: 'app-details-facture-gestionnaire',
   imports: [ CommonModule,FormsModule],
  templateUrl: './details-facture-gestionnaire.component.html',
  styleUrls: ['./details-facture-gestionnaire.component.scss'],
  standalone:true,
})
export class DetailsFactureGestionnaireComponent {
